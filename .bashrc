...
alias lsl='ls -l'
alias lsla='ls -la'
alias home='loc=`pwd`; cd; lsl'
alias back='cd $loc; lsl'
alias chrome='google-chrome'
alias batt='upower -i /org/freedesktop/UPower/devices/battery_BAT0 | grep -E "time to (full|empty)"'
alias pgrep='pgrep -l'
alias tl='tree -L 1 -phFC'
